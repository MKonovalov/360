...
- [x] **QLTY-03**: A live-browser UAT matrix replicates the v1.1 Phase-5 pattern — expanded / collapsed / mobile × the 4 routes × active/inactive state pairs, with screenshots
