...
- [x] **RUN-05**: `model_used`/`model_chain` audit records the served provider accurately for all 4 providers (OpenCode rows recorded by their bare id; provider derivation via the priority-ordered registry)
